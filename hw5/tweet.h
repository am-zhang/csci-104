...
class Tweet
{
 public:
  ...
  std::vector<std::string> mentions() const;

  bool isMention; // presence of mentions

  bool startMention; // starts with a mention
  ...
  DateTime time_;
  std::string text_;
  std::set<std::string> hashtags_; // all lowercase
